...
{
    enum Mode { RevertInstances, CreateInstances }
    Mode mode = Mode.RevertInstances;
    [MenuItem("Tools/FlammAlpha/Revert Material Instances")]
    ...
    List<InstanceIssue> issues = new List<InstanceIssue>();
    Vector2 scroll;
    ...
    void ScanMaterialInstances(GameObject root)
    {
        issues.Clear();
    ...
    void ScanAssetMaterials(GameObject root)
    {
        issues.Clear();
    ...
    Material FindBestMaterialMatch(Material instance, List<Material> assets)
    {
